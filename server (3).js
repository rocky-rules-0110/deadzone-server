...
io.on('connection', (socket) => {
  ...
  socket.on('approve_join', ({ partyId, socketId }) => {
    ...
    // Generate a shared map seed so both players get identical maps
  ...
  // ── GAME STATE SYNC — HOST AUTHORITATIVE ────────────────────────────
  // Host streams full game state → relay to guest
